    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single"
                   @click="handleUpdate"
                   v-hasPermi="['pm:question:edit']">
          修改
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini"
                   :disabled="multiple" @click="handleDelete" v-hasPermi="['pm:question:remove']">
          删除
        </el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="questionList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="题型" align="center" prop="questionType">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sch_question_type" :value="scope.row.questionType"/>
        </template>
      </el-table-column>
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="题型">
          <el-select v-model="form.questionType">
            <el-option v-for="dict in dict.type.sch_question_type" :key="dict.value" :label="dict.label" :value="dict.value">
        ...
        <el-form-item label="答案" prop="answer">
          <el-input v-model="form.answer" placeholder="请输入题目答案"/>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      pageQuestion(this.queryParams).then(response => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('pm/question/export', {
        ...this.queryParams
