...
//        if (StringUtils.isEmpty(tableName)) {
    ...
    private <T> void buildFieldValue(Map<String, Object> map, T newInstance, Field field, String name) throws IllegalAccessException {
        if ("class java.time.LocalDateTime".equals(field.getGenericType().toString()) && map.get(name) != null) {
            field.set(newInstance, Timestamp.valueOf(map.get(name).toString()).toLocalDateTime());
        } else if ("class java.time.LocalDate".equals(field.getGenericType().toString()) && map.get(name) != null) {
            field.set(newInstance, Date.valueOf(map.get(name).toString()).toLocalDate());
        } else if ("class java.time.LocalTime".equals(field.getGenericType().toString()) && map.get(name) != null) {
            field.set(newInstance, Time.valueOf(map.get(name).toString()).toLocalTime());
        } else if ("class java.lang.Short".equals(field.getGenericType().toString()) && map.get(name) != null) {
